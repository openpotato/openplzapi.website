...
Die Daten des OpenPLZ API-Projekts werden regelmäßig aktualisiert. Zur Zeit streben wir eine halbjährliche Aktualisierung an. Der aktuelle Stand der Daten wird stets im [Änderungslog](change-log-data.md) dokumentiert.
