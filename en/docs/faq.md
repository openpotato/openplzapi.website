...
The data of the OpenPLZ API project is updated regularly. We are currently aiming for half-yearly updates. The current status of the data is always documented in the [change log](change-log-data.md).
