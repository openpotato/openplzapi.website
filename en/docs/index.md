**OpenPLZ API** is a [open data project](https://opendatahandbook.org/guide/de/what-is-open-data/) that makes a public street and postal code directory for Austria, Germany, Liechtenstein and Switzerland available via an open REST API interface. The following data can be retrieved:
